...
<body>
  ...
  <div id="content">
  	...
  	<section class="grant-grid">
        <div class="container">
            <div class="grant-wrapper active-grant">
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-6">
                    <div class="thumbnail narrow-thumbnail same-height">
                      ...
                      <div class="grant-date blue">
                        <span class="grant-icon blue-bg white">
            ...
            <div class="grant-wrapper closed-grant">
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-6">
                    <div class="thumbnail narrow-thumbnail same-height">
                      ...
                      <div class="grant-date dkgrey">
                        <span class="grant-icon dkgrey-bg white">
                          <em class="fa fa-calendar"></em>
                        </span>
                        Closed March 1, 2016
                      </div>
